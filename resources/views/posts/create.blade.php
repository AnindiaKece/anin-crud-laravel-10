                    ...
                    <div class="card-body">
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold form-label">GAMBAR</label>
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold form-label">JUDUL</label>
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold form-label">KONTEN</label>
